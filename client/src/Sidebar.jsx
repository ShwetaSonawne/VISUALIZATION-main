      ...
      <styledDrawer variant="permanent" open={open}>
        ...
        <List>
          <ListItem disablePadding sx={{ display: 'block' }} onClick={()=> {navigate("/home")}}>
            ...
            <ListItem disablePadding sx={{ display: 'block' }} onClick={()=> {navigate("/geochart")}}>
              <ListItemButton
                sx={{
                  minHeight: 48,
                  justifyContent: open ? 'initial' : 'center',
              ...
              >
                ...
                <ListItemText primary="Geography" sx={{ opacity: open ? 1 : 0 }} />
              </ListItemButton>
            </ListItem>
            ...
            <ListItem disablePadding sx={{ display: 'block' }} onClick={()=> {navigate("/linechart")}}>
              <ListItemButton
                sx={{
                  minHeight: 48,
                  justifyContent: open ? 'initial' : 'center',
